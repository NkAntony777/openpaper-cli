    ...
    def get_best_gemini_key(
        ...
        keys = [
            (
                primary,
                APIType.GEMINI_PRIMARY,
                self._get(f"api:{APIType.GEMINI_PRIMARY.value}:429_count", 0),
            ),
            (
                fallback,
                APIType.GEMINI_FALLBACK,
                self._get(f"api:{APIType.GEMINI_FALLBACK.value}:429_count", 0),
            ),
        ]
        ...
        if fallback_2:
            keys.append(
                (
                    fallback_2,
                    APIType.GEMINI_FALLBACK_2,
                    self._get(f"api:{APIType.GEMINI_FALLBACK_2.value}:429_count", 0),
                )
            )
        ...
        if fallback_3:
            keys.append(
                (
                    fallback_3,
                    APIType.GEMINI_FALLBACK_3,
                    self._get(f"api:{APIType.GEMINI_FALLBACK_3.value}:429_count", 0),
                )
            )
